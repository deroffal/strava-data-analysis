...
import static fr.deroffal.stravastatistics.repository.MongoConfiguration.DETAILED_ACTIVITY_JAVA_COLLECTION;
...
@Document(collection = DETAILED_ACTIVITY_JAVA_COLLECTION)
